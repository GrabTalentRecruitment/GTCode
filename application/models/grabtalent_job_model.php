...
class Grabtalent_job_model extends CI_Model {
    ...
    var $row = array(
        ...
        'job_hrcontactname' => null,
        'job_hrcontactemail' => null,
        'job_hiringmgrcontactname' => null,
        'job_hiringmgrcontactemail' => null,
        'job_category' => null,
        'job_function' => null,
        'job_industry' => null,
        ...
        'job_last_modified_by' => null,
        'job_last_modified_date' => null,
        'job_view_count' => null,
        'job_active' => null,
        'job_video_url' => null
    );
