...
<?php
    ...
    $this->db->select('*')->from('candidate_application')->where($condition);
    $query = $this->db->get();
    if ($query->num_rows() > 0) {
...
<div class="site-content">
    <div class="container page-header">
        <div class="row">
            <div class="col-md-6 no-padding">
                <h1 class="page-title font-1"><?php echo "Job Id: ".$this->uri->segment(4); ?></h1>
            </div>
            <div class="col-md-6 no-padding">
                <div class="subpage-breadcrumbs">
                    <a href="<?php echo https_url($this->lang->lang().'/recruiter/applicant_tracking',true); ?>"><?php echo lang('recruiterlogin.applnTrackhding'); ?></a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        ?>
                            <tr>
                                <td style="vertical-align: middle;">
                                    <?php echo "<a href='".https_url($this->lang->lang()."/recruiter/applicant_view/".$cand['candidate_coderefs_id'])."' role='button'>".$result[0]['candidate_lastname']." ".$result[0]['candidate_firstname']."</a>"?>
                                </td>
                                ...
                                <td style="vertical-align: middle; text-align: center;">
                                    <a href='<?php echo $resumeDownload_url.$result[0]['resume_url']; ?>'><img src="/images/icons/icon_resume.jpg" title="<?=lang('candidateprofile.viewResumeBtn')?>" width="50px" style="cursor: pointer;"/></a>
                                </td>
                                <td style="vertical-align: middle; text-align: center;">
                                    <?php
                                ...
                                <td style="vertical-align: middle; text-align:center;">
                                    <a title="<?php echo $candStage; ?>" data-toggle="modal" data-whatever="<?php echo $result[0]['candidate_lastname']." ".$result[0]['candidate_firstname']; ?>" id="<?php echo $cand['candidate_coderefs_id']; ?>" data-target="#candStepModal" style="cursor:pointer;"><img src="/images/icons/icon_nextStep.png" alt="Proceed to Next Step" title="Proceed to Next Step" width="50px" style="cursor: pointer;"/></a>
                                </td>
                            </tr>
                        <?php } ?>
                    <?php } else{ ?>
    ...
    <!-- Candidate Step Change Modal Window -->
