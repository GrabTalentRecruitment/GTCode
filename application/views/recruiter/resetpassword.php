<?php $back_url = $this->lang->lang().'/recruiter'; $resetpasswd_url = $this->lang->lang().'/recruiter/changepasswd'; $recruiteremail = $this->input->get('ed', TRUE); ?>
...
<input type="hidden" id="inputrecruiterresetpwdUrl" value="<?php echo https_url($resetpasswd_url); ?>"  />
<input type="hidden" id="inputrecruiterbackUrl" value="<?php echo https_url($back_url); ?>"  />
                ...
                <div class="panel panel-default">
					<div class="panel-body">
                        ...
                        <form method="post" accept-charset="utf-8" role="form" enctype="multipart-form/data">
                            <input type="hidden" name="inputemailaddress" id="inputemailaddress" value="<?php echo $recruiteremail; ?>" />
                            <div class="row">
                                <div class="col-md-12">
