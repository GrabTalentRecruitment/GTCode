                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php if($jobs){ ?>
                                        ...
                                        <tr>
                                            <td style="vertical-align: middle;"><?php echo "<a href='".https_url($this->lang->lang().'/recruiter/applicant_job_view/'.$job['job_number'])."' role='button'>".$job['job_number']."</a>"?></td>
                                            <td class="job-title" style="vertical-align: middle;"><a href="<?php echo https_url($this->lang->lang().'/recruiter/job/'.$job['job_number']); ?>"><?php if( strlen(htmlspecialchars($job['job_title'])) > 20 ) { echo substr_replace(htmlspecialchars($job['job_title']), '...', 40);} else { echo htmlspecialchars($job['job_title']); }?></a></td>
                                            ...
                                            <td style="vertical-align: middle;">
                                                <?php 
                                                    $hiring_mgr = $this->db->select('employer_contact_firstname, employer_contact_lastname')->where('employer_contact_email', $job['job_created_by'])->get('employers')->result_array();
                                            ...
                                            <?php
                                                ...
                                                if($total_count > 0) {
                                                    ...
                                                    echo "<td style='vertical-align: middle;'><center><font size='4px'><b>-</b></font></center></td>";
                                                }
                                            ?>
                                            <?php
                                            ...
                                            <td style="vertical-align: middle; text-align: left !important;">
                                                <?php
                                                    if($job_status[0]['job_active'] == 'Yes') {
                                                ?>
                                                    <a id="jobstatusUpdate" data-toggle="modal" data-target="#JobstatusupdateModal" title="<?php echo $job['job_number']; ?>"><img src="/images/icons/icon_rejectStep.png" alt="Close Job" title="Close Job" height="50px" style="cursor: pointer;"/></a>
                                                <?php
                                                    }
                                                ?>
