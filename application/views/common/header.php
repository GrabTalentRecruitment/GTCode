            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        <?php
                            if( ($this->uri->segment(2) == 'home') ) {
                                echo '<li class="active"><a href="'.http_url($this->lang->lang().'/home').'">'.lang('home.index').'</a></li>';
                            } else {
                                echo '<li><a href="'.http_url($this->lang->lang().'/home').'">'.lang('home.index').'</a></li>';
                            }
                                                        
                            if( $this->uri->segment(2) == 'aboutus'){
                                echo '<li class="active"><a href="'.http_url($this->lang->lang().'/aboutus').'">'.lang('home.about').'</a></li>';
                            } else {
                                echo '<li><a href="'.http_url($this->lang->lang().'/aboutus').'">'.lang('home.about').'</a></li>';
                            }
                                                        
                            if( $this->uri->segment(2) == 'contact'){
                                echo '<li class="active"><a href="'.http_url($this->lang->lang().'/contact').'">'.lang('home.contact').'</a></li>';
                            } else {
                    ...
                    <div class="navbar-form navbar-right">                        
                        <a href="<?php echo https_url($this->lang->lang().'/recruiter', true); ?>" class="btn btn-danger"><?php echo lang('home.recruiter'); ?></a>
                        <a href="<?php echo https_url($this->lang->lang().'/candidate', true); ?>" class="btn btn-primary"><?php echo lang('home.jobseeker'); ?></a>
                    </div>
                </div>
            </div>
        </nav>
