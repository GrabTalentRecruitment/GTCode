...
<div class="site-content">
	<div class="container page-header">
		...
		<div class="col-md-6 no-padding">
		   <h1 class="page-title font-1"><?=lang('presentation.heading1');?></h1>
	        </div>
            </div>
	</div>
    <div class="page-content container" >
        <div class="row" align="center">            
            <iframe width="1120" height="630" src="https://www.youtube.com/embed/nultqk534SQ" frameborder="0" allowfullscreen></iframe>
        </div>    
    </div>
</div>
