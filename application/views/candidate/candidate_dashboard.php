...
<div class="container page-header">
    ...
    <div class="page-content container">
        ...
        <div class="row">
            ...
            <!-- Left side pane - start -->
            <div class="col-xs-12 col-sm-6 col-sm-offset-3 col-md-3 col-md-offset-0 col-lg-3 col-lg-offset-0">
                <div class="card">
                    <div class="panel panel-danger">
                		...
                		<div class="profile-userpic text-center">
                                    ...
                                    ?>
                                    <img alt="User Pic" src="<?php echo '/images/candidate/photo/'.$sess_data[0]['candidate_profilepicurl'];?>" />
                                    <?php } else { ?>
                                    <img alt="User Pic" src="/images/myprofile.jpg" height="90px" />
                                    <?php } ?>
                				</div>
                                ...
                                <?php 
                                    ...
                                    echo $usrdt['candidate_phonecountrycode']. " ". $usrdt['candidate_phonenumber']; echo "<br />";
                                    echo $usrdt['candidate_email']; echo "<br />";
                                    echo $usrdt['candidate_gender']; echo "<br />";
                                    echo "</p>";
                                ?>
                                <?php } ?>
                                
                                <div class="col-xs-6 col-sm-12 col-sm-offset-4 col-md-12 col-md-offset-3 col-lg-12 text-center">
            ...
            <!-- Right Pane - start -->
            <div class="col-xs-12 col-sm-12 col-md-9 col-md-offset-0 col-lg-9 col-lg-offset-0">
                <!-- Nav tabs -->
                <div class="card">
                    <ul class="nav nav-tabs" role="tablist" style="margin-left:0px !important;">
                        ...
                        <li role="presentation"><a href="#cand_references" aria-controls="cand_references" role="tab" data-toggle="tab">Candidate References</a></li>
                        <li role="presentation"><a href="#academics" aria-controls="academics" role="tab" data-toggle="tab">Academic Details</a></li>
                        <li role="presentation"><a href="#workexp" aria-controls="workexp" role="tab" data-toggle="tab">Work-Experience</a></li>
                        <li role="presentation"><a href="#applications" aria-controls="applications" role="tab" data-toggle="tab">Job Applications</a></li>
                    </ul>
                
                    <!-- Tab panes -->
                    <div class="tab-content">
                    
                        <!-- Skills Tab Right Pane - start -->
                        <div role="tabpanel" class="tab-pane active" id="skills"><br />
                            <h4><?=lang('candidatedash.skills')?>:<button type="button" class="btn btn-md btn-primary pull-right" data-toggle="modal" data-target="#skillModal" title="Add more Skills">Add</button></h4>
                            
                            <!-- To show on Mobiles only. -->
                            <?php
                            ...
                            <div class="panel panel-primary visible-xs-block">
                                ...
                                <div class="panel-body">
                                    <div class="progress">
                                        ...
                                        ?>
                                        <div class="progress-bar progress-bar-success progress-bar-striped" role="progressbar" aria-valuenow="3" aria-valuemin="0" aria-valuemax="5" <?php echo "style='width:".$progressPercent."%';>"; ?>> <?php echo "<strong><font size='3%'>".$sklval[2]."</font></strong>"; ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- To show on Desktop, Tablets only. -->
                    ...
                    <!-- Candidate References Tab Right Pane - start -->
                    <div role="tabpanel" class="tab-pane" id="cand_references"><br />
                        <h4><?=lang('candidatedash.candidatereference');?>:<button type="button" class="btn btn-md btn-primary pull-right" data-toggle="modal" data-target="#candRefModal" title="Add Candidate References">Add</button></h4>
                        <?php
                            $candRefId = $this->session->userdata('user_data')[0];
                            $query = $this->db->select('*')->where_in('candidate_ref_id', $candRefId['candidate_ref_id'])->get('candidate_references');
                            foreach ($query->result_array() as $row) {
                        ?>
                        ...
                        <div class="panel panel-default">
                            <table class="table table-bordered table-responsive hidden-xs">
                                ...
                                <tbody>
                                    <?php
                                        $candRefId = $this->session->userdata('user_data')[0];
                                        $query = $this->db->select('*')->where('candidate_ref_id', $candRefId['candidate_ref_id'] )->get('candidate_references');
                                        foreach ($query->result_array() as $row) {
                    ...
                    <!-- Candidate References Tab Right Pane - end -->
                    
                    <!-- Academic Details Tab Right Pane - start -->
                    <div role="tabpanel" class="tab-pane" id="academics"><br />
                        <h4><?=lang('candidatedash.academicdetails')?>:<button type="button" class="btn btn-md btn-primary pull-right" data-toggle="modal" data-target="#eduLvlModal" title="Add Academic Details">Add</button></h4>                                    
                        <?php
                    ...
                    <!-- Academic Details Tab Right Pane - end -->
                    
                    <!-- Work Experience Details Tab Right Pane - start -->
                    <div role="tabpanel" class="tab-pane" id="workexp"><br />
                        <h4><?=lang('candidatedash.workexp')?>:<button type="button" class="btn btn-md btn-primary pull-right" data-toggle="modal" data-target="#workExpModal" title="Add Work Experience">Add</button></h4>
                        <?php
                        ...
                        <div class="panel panel-primary visible-xs-block">
                            <div class="panel-heading"><?php 
                                ...
                                echo "<div class='col-xs-6'><button type='button' class='btn btn-md btn-danger pull-right' data-toggle='modal' id='workExp-btn-delete' value='".$row["candidate_coderefs_id"]."'><span class='fa fa-trash'></span></button>&nbsp;&nbsp;<button type='button' class='btn btn-md btn-success pull-right' data-toggle='modal' data-target='#WorkExpUpdModal' id='workExp-btn-fetch' value='".$row["candidate_coderefs_id"]."'><span class='fa fa-pencil'></span></button></div>";
                                echo "</div>"
                                ?></div>
                            <div class="panel-body">
                                <table class="table borderless">
                    ...
                    <!-- Work Experience Tab Right Pane - end -->
                    
                    <!-- Candidate Applications Tab Right Pane - end -->
                    <div role="tabpanel" class="tab-pane" id="applications"><br />
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            foreach ($query->result_array() as $row) {
                                                ...
                                                echo "<tr>";
                                                    echo "<td><strong>".lang('candidatedash.mypastapplnheading1')."</strong></td>";
                                                ...
                                                echo "<tr>";
                                                    echo "<td><strong>".lang('candidatedash.mypastapplnheading4')."</strong></td>";
                                                    echo "<td>".$client_name[0]['employer_name']."</td>";
                                                echo "</tr>";
                                                
                                                echo "<tr>";
                                                    echo "<td><strong>".lang('candidatedash.mypastapplnheading2')."</strong></td>";
                                                    echo "<td>".date("d-M-Y h:m:s",strtotime($row['cand_appln_created_date']))."</td>";
                                                echo "</tr>";
                                                
                                                echo "<tr>";
                                                    echo "<td><strong>".lang('candidatedash.mypastapplnheading3')."</strong></td>";
                                                    echo "<td>".date("d-M-Y",strtotime($jobDetails[0]['job_postdate']))."</td>";
                                                echo "</tr>";
                                                
                                                echo "<tr>";
                                                    echo "<td><strong>".lang('candidatedash.mypastapplnheading5')."</strong></td>";
                                                    echo "<td>".$row['candidate_appln_stage']."</td>";
                                                echo "</tr>";
                                                
                                                echo "<tr>";
                                                    echo "<td><strong>".lang('candidatedash.mypastapplnheading6')."</strong></td>";
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" accept-charset="utf-8" enctype="multipart/form-data" role="form" id="example-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" id="candrefUpd-refCode" name="candrefUpd-refCode" />
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form method="post" accept-charset="utf-8" enctype="multipart/form-data" role="form" id="example-form">
                            ...
                            <input type="hidden" id="educLvlUpd-refCode" name="educLvlUpd-refCode" />
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
